...
namespace ds
{
    ...
    private:
        ...
        std::shared_ptr<ConfigurationManager> _configuration_loader;
    ...
    protected:
        ...
        virtual std::shared_ptr<ConfigurationManager>
    ...
    public:
        ...
        std::shared_ptr<ConfigurationManager> get_configuration_loader();
    };
};  // namespace ds
